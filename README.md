...
- **Joint (H, η) refit.** Adding the per-expiry ATM skew to the calibration objective moves rough Bergomi's optimum to H = 0.31, ρ = −0.50, forward vol 12.5 % (bootstrap H 0.308 ± 0.011) and puts the Monte Carlo skew exponent at −0.264 ± 0.007, half a market SE from −0.249, for 0.45 vol points of smile RMSE; the served calibration's exponent is −0.330, 2.5 SE away. Profile, Pareto front and validation in [docs/joint_skew_refit.md](docs/joint_skew_refit.md).
